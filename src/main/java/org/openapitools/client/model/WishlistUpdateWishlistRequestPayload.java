...
public class WishlistUpdateWishlistRequestPayload {
   ...
   * @return the WishlistUpdateWishlistRequestPayload instance itself
   */
  public WishlistUpdateWishlistRequestPayload putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.privacy, wishlistUpdateWishlistRequestPayload.privacy) &&
        ...
        Objects.equals(this.additionalProperties, wishlistUpdateWishlistRequestPayload.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(privacy, label, description, isDefault, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WishlistUpdateWishlistRequestPayload>() {
           ...
           public WishlistUpdateWishlistRequestPayload read(JsonReader in) throws IOException {
             ...
             WishlistUpdateWishlistRequestPayload instance = thisAdapter.fromJsonTree(jsonObj);
