...
public class WishlistCreateWishlistRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tenantId, privacy, label, description, customerGrn, isDefault);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WishlistCreateWishlistRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WishlistCreateWishlistRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
