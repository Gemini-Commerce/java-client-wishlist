...
public class WishlistGetWishlistBySharedCodeRequest {
   ...
   * @return the WishlistGetWishlistBySharedCodeRequest instance itself
   */
  public WishlistGetWishlistBySharedCodeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, wishlistGetWishlistBySharedCodeRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, wishlistGetWishlistBySharedCodeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, sharedCode, customerGrn, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WishlistGetWishlistBySharedCodeRequest>() {
           ...
           public WishlistGetWishlistBySharedCodeRequest read(JsonReader in) throws IOException {
             ...
             WishlistGetWishlistBySharedCodeRequest instance = thisAdapter.fromJsonTree(jsonObj);
