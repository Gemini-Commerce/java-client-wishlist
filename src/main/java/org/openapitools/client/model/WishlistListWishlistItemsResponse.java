...
public class WishlistListWishlistItemsResponse {
  ...
  private List<WishlistWishlistItemResponse> wishlistItems = new ArrayList<>();
   ...
   * @return the WishlistListWishlistItemsResponse instance itself
   */
  public WishlistListWishlistItemsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.wishlistItems, wishlistListWishlistItemsResponse.wishlistItems) &&
        ...
        Objects.equals(this.additionalProperties, wishlistListWishlistItemsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(wishlistItems, nextPageToken, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WishlistListWishlistItemsResponse>() {
           ...
           public WishlistListWishlistItemsResponse read(JsonReader in) throws IOException {
             ...
             WishlistListWishlistItemsResponse instance = thisAdapter.fromJsonTree(jsonObj);
