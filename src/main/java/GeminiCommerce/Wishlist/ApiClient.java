...
import GeminiCommerce.Wishlist.auth.Authentication;
import GeminiCommerce.Wishlist.auth.HttpBasicAuth;
import GeminiCommerce.Wishlist.auth.HttpBearerAuth;
import GeminiCommerce.Wishlist.auth.ApiKeyAuth;
import GeminiCommerce.Wishlist.auth.OAuth;
import GeminiCommerce.Wishlist.auth.RetryingOAuth;
import GeminiCommerce.Wishlist.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * @return a {@link GeminiCommerce.Wishlist.ApiClient} object
     */
    ...
    */
     ...
     * @throws GeminiCommerce.Wishlist.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce.Wishlist.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce.Wishlist.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce.Wishlist.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce.Wishlist.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce.Wishlist.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce.Wishlist.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce.Wishlist.ApiException If fail to serialize the request body object into a string
     */
